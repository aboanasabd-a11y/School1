...
export const GeneralManagerPortal: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Direct Link Generator & Dispatch Banner for General Manager */}
      <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 text-white rounded-xl p-4 shadow-md border border-blue-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2 font-bold text-sm">
            <span className="p-1 rounded bg-blue-500/30 border border-blue-400/40 text-blue-300">
              🔗
            </span>
            <span>نظام إرسال الروابط المباشرة للمعلمين وأولياء الأمور</span>
            <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-400/30">
              مفعل ومباشر
            </span>
          </div>
          <p className="text-xs text-blue-200">
            أرسل رابطاً مخصصاً للمعلم للدخول فوراً إلى صفحته المجهزة مسبقاً، أو أرسل رابطاً لولي الأمر بالرقم الأكاديمي للطالب للاطلاع المباشر على مستوى ابنه بدون الحاجة لكلمات مرور معقدة.
          </p>
        </div>

        <div className="flex flex-wrap items-center gap-2 shrink-0">
          <button
            onClick={() => openSmartLinksModal("teacher")}
            className="px-3.5 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
            <Users className="w-3.5 h-3.5" />
            <span>إرسال رابط لمعلم</span>
          </button>
          <button
            onClick={() => openSmartLinksModal("parent")}
            className="px-3.5 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
            <GraduationCap className="w-3.5 h-3.5" />
            <span>إرسال رابط لولي أمر برقم الطالب</span>
          </button>
          <button
            onClick={() => openSmartLinksModal()}
            className="px-3.5 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-xs font-bold border border-white/20 transition-colors flex items-center gap-1.5 cursor-pointer"
          >
            <Share2 className="w-3.5 h-3.5" />
            <span>عرض كافة الروابط</span>
          </button>
        </div>
      </div>
